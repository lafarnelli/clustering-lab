...
```
Question 1: On unscaled data (popdensity is a much larger contributor than any of the other variables), use elbow, silhouette, and gap statistic to evaluate the optimal number of clusters for the unscaled data. 
