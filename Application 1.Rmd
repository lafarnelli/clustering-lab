...
ggplot(CD1, aes(x = , y = Val)) + geom_boxplot() + coord_flip() + facet_wrap(~ Model, scales = "free") + labs(title="RFM Variable Distributions") #add title “RFM Variable Distributions” according to instructions; "x = " based on 3rd hint
