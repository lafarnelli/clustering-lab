...
```
Question 1: Using the distance matrix D from the earlier code, analyze the plants data using PAM clustering. 
```{r}
...
colMeans(X[pm$clustering == 2,]) ## Used to interpret the cluster
```
